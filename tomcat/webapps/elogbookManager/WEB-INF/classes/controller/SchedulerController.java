...
public class SchedulerController implements JobListener, TriggerListener {
    ...
    private SchedulerController() 
    {
        ...
        if (Settings.LOG_ALL_SCHEDULER_ACTIONS)
        {
            try {
                ...
                LogHelper.getInstance().log("Could not add Listeners "+ex.toString());
            }
        }
    }
        ...
        try {
            ...
            for (int i = 0; i < triggerGroups.length; i++)
            {
                ...
                for (int j = 0; j < triggerNames.length; j++)
                {
                    ...
                    LogHelper.getInstance().log("unscheduling " + triggerNames[j]+ " " + triggerGroups[i] + " ("+result+")");
                }
            }
            ...
            LogHelper.getInstance().log(ex.toString());
        }
    }
    ...
    public String getPrevLaunchTime(String job, String group)
    {
        ...
        try {
            ...
            LogHelper.getInstance().log(ex.toString()+" SchedulerController.java 190");
        }
    ...
    public void jobToBeExecuted(JobExecutionContext arg0) {
        ...
        LogHelper.getInstance().log(result);
    }

    //@Override
    public void jobExecutionVetoed(JobExecutionContext arg0) {
        LogHelper.getInstance().log("jobExecutionVetoed: "+arg0.toString());
    }
    ...
    public void triggerMisfired(Trigger arg0) {
        LogHelper.getInstance().log("triggerMisfired: "+arg0.toString());
    }
